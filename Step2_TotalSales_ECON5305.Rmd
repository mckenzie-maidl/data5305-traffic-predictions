...
generate_forecasts <- function(ts, model_order, h, perf_func=measure_performance) {
  ...
  # equal-weighted forecast: average of all forecasts
  ...
  # MSE-inverse weight forecast: product(weights * forecast) / weight: 1/MSE of forecast
  ...
  # return results
  return(list(performance_results = results, combined_forecast_mse = combo_forecast_mse))
}
```
